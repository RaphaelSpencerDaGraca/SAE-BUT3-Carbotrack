...
export const translations: Record<Language, Record<string, string>> = {
    fr: {
        ...
        "dashboard.stats.co2.helper.p26_50": "Proche de la moyenne… mais ça reste au dessus avec {worse}%.",
    ...
    en: {
        ...
        "dashboard.stats.co2.helper.p26_50": "Close to average… but still above it with {worse}%.",
